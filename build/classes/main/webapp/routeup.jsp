...
<div class="bord">
  <div class="container">
    ...
    <section class="main">
      <div class="main-top">
        <div class="contain">
      <h1 class="form-title">Update Routes Information</h1>
       <%
String rno=request.getParameter("route_id");
try{
	Class.forName("com.mysql.jdbc.Driver");
}catch(ClassNotFoundException e){
	e.printStackTrace();
}
String selectquery="select * from route where route_id="+rno;
Connection conn;
try{
...
%>
      ...
      <input type="hidden" name="route_id" value="<%=rs.getString(1) %>">
        <div class="main-user-info">
       
          <div class="user-input-box">
            <label for="username">Source</label>
            <input type="text"name="source" value="<%=rs.getString(2)%>" >
          </div>
          <div class="user-input-box">
            <label for="username">Destination</label>
            <input type="text"name="destination" value="<%=rs.getString(3)%>" >
          </div>
          <div class="user-input-box">
          ...
          <div class="user-input-box">
           ...
           <input type="text"name="time" value="<%=rs.getString(10)%>">
          </div>
          <div class="user-input-box">
            <label for="email">Depart</label>
           <input type="text"name="depart" value="<%=rs.getString(5)%>">
          </div>
          <div class="user-input-box">
            <label for="phoneNumber">Arrive</label>
          <input type="text"name="arrive" value="<%=rs.getString(6)%>">
          </div>
           <div class="user-input-box">
            <label for="password">Duration</label>
            <input type="text"name="Duration" value="<%=rs.getString(8)%>">
          </div>
          <div class="user-input-box">
            <label for="password">Price</label>
            <input type="text"name="price" value="<%=rs.getString(7)%>">
          </div>
