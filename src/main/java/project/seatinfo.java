...
public class seatinfo extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String selectquery="";
		 ...
		 selectquery="select * from route where source like'%"+from+"%' AND destination like '%"+to+"%'";
		Connection conn; 
		try{
			...
			while(rs.next()) {
				...
				out.print("<p class=\"t\"> "+rs.getString(4)+","+rs.getString(10)+"</p><h4> "+rs.getString(2)+"-"+rs.getString(3)+"</h4><p>Depart:"+rs.getString(5)+"</p><p>Arrive:"+rs.getString(6)+"</p><p>Duration:"+rs.getString(8)+"</p>" );
				...
				out.println("<a href=\"seatinfo.jsp\"><input type=\"submit\" name=\"\" value=\"Show Seats\"></a> ");
				out.println("</div>");
				out.println("</div>");
			}
			if (!dataFound) {
