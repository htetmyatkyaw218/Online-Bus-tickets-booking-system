...
<div class="bord">
	...
	Class.forName("com.mysql.jdbc.Driver");
        	...
        	<tr>
        		...
        		<td><a href="routeup.jsp?route_id=<%=rs.getString(1)%>" class="a">&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-file-pen fa-lg"></i>&nbsp;</a></td>
				<td><a href="routede?method=get&route_id=<%=rs.getString(1) %>" class="a">&nbsp;&nbsp;<i class="fa-solid fa-trash fa-lg"></i>&nbsp;&nbsp;</a></td>
        	</tr>
        	</tbody>
        	<%  
				}
