  ...
  <div class="container">
	...
	Class.forName("com.mysql.jdbc.Driver");
        	...
        	<tr>
        		...
        		<td><a href="debooking.jsp?method=get&from=<%=rs.getString(2)%>&to=<%=rs.getString(3)%>&date=<%=rs.getString(4)%>" class="a"><p>Show Book<i class="fa-solid fa-eye"></i></p></a></td>
        		<td><a href="debook?method=get&f=<%=rs.getString(2)%>&t=<%=rs.getString(3)%>&d=<%=rs.getString(4)%>" class="a"><p style=" padding: 10px; "><i class="fa-solid fa-trash fa-lg"></i></p></a></td>
        	</tr>
        	</tbody>
        	<%  
				}
