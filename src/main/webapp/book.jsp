...
<div class="bord">
  <div class="container">
	...
	Class.forName("com.mysql.jdbc.Driver");
		...
		String price="select price from route where source like'%"+from2+"%' and destination like'%"+to2+"%'and Date like'%"+Date2+"%'";
			Connection conn3; 
			try{
				conn3=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","root");
				Statement st3=conn3.createStatement();
				ResultSet rs3=st3.executeQuery(price);
				int p=0;
				if(rs3.next()){
					p=rs3.getInt(1); 
				}
