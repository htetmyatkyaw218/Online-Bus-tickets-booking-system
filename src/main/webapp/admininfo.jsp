...
<div class="bord">
  <div class="container">
	...
	Class.forName("com.mysql.jdbc.Driver");
			...
			String count="select count(admin_id) from admin";
			Connection conn; 
			try{
	...
	Class.forName("com.mysql.jdbc.Driver");
        	...
        	<tr>
        		...
        		<td><a href="adminup.jsp?admin_id=<%=rs.getString(1)%>" class="a"><p><i class="fa-solid fa-file-pen"></i></p></a></td>
				<td><a href="adminde?method=get&admin_id=<%=rs.getString(1) %>" class="a"><p><i class="fa-solid fa-user-xmark"></i></p></a></td>
        	</tr>
        	</tbody>
        	<%  
				}
